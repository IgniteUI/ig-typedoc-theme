                    ...
                    <div class="globalnav__wrapper">
                        ...
                        <nav class="globalnav__menu-container">
                            <ul class="navigation navigation--navbar navigation--hpad-0 sf-menu sf-js-enabled sf-arrows">
                                <li class="navigation__mobile-link"><a class="navigation__sub-menu sf-with-ul mchNoDecorate" href="#">マイ アカウント</a>
                                ...
                                <li class="menu-full-width"><a class="navigation__sub-menu sf-with-ul mchNoDecorate" title="開発" href="/products/all"><span>開発</span></a>
                                    <ul style="display: none; opacity: 0;">
                                        <li>
                                            <div class="mar-bottom--sm">
                                                <div class="navigation__sub-menu-header">お買い得</div>
                                                <div class="emphasize"><a href="/products/ultimate" class="mchNoDecorate">Infragistics Ultimate <span class="deemphasize">Web、モバイル、デスクトップ アプリケーション開発をサポート</span> </a></div>
                                            </div>
                                            <div>
                                                <div class="emphasize"><a href="/products/indigo-design" class="mchNoDecorate">Indigo.Design <span class="deemphasize">3ステップでデザインから画面コードを生成できるアプリケーションデザインプラットフォーム</span> </a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="navigation__sub-menu-header">WEB向け</div>
                                            <a class="deemphasize mchNoDecorate" href="/products/ignite-ui-angular">Ignite UI for Angular</a> <a class="deemphasize mchNoDecorate" href="/products/ignite-ui">Ignite UI for JavaScript</a> <a class="deemphasize mchNoDecorate" href="/products/ignite-ui-react">Ignite UI for React</a> <a class="deemphasize mchNoDecorate" href="/products/aspnet">Ultimate UI for ASP.NET</a> <a class="deemphasize mchNoDecorate" href="/products/indigo-design">Indigo.Design</a></li>
                                        <li>
                                            <div class="navigation__sub-menu-header">デスクトップ向け</div>
                                            <a href="/products/windows-forms" class="mchNoDecorate">Ultimate UI for Windows Forms</a> <a href="/products/wpf" class="mchNoDecorate">Ultimate UI for WPF</a>
                                            <div class="navigation__sub-menu-header">プロトタイピング</div>
                                            <a href="/products/indigo-design" class="mchNoDecorate">Indigo.Design</a></li>
                                        <li>
                                            <div class="navigation__sub-menu-header">モバイル向け</div>
                                            <a href="/products/xamarin" class="mchNoDecorate">Ultimate UI for Xamarin</a> <a href="/products/ios" class="mchNoDecorate">Ultimate UI for iOS</a> <a href="/products/android" class="mchNoDecorate">Ultimate UI for Android</a></li>
                                        <li>
                                            <div class="navigation__sub-menu-header">自動テスト ツール</div>
                                ...
                                <li><a class="navigation__sub-menu sf-with-ul mchNoDecorate" title="UX" href="/products/indigo-design">UX</a>
                                    <ul style="display: none;">
                                        ...
                                        <li><a title="Indigo.Design Desktop" href="/products/indigo-design/desktop" class="mchNoDecorate">Indigo.Design Desktop <span class="deemphasize">プロトタイプの迅速な構築、コラボレーションの実現、ユーザビリティ テストの実施を可能にする UX デザイン ツール</span></a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a class="navigation__sub-menu sf-with-ul mchNoDecorate" title="リソース" href="/support/product-help-downloads">リソース</a>
                                    <ul style="display: none;">
                                ...
                                <li><a class="navigation__sub-menu sf-with-ul mchNoDecorate" data-id="12495" href="/how-to-buy">ご購入</a>
                                    <ul style="display: none;">
